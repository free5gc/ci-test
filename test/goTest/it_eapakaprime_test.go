...
func TestEAPAKAPrimeAuthentication(t *testing.T) {
	...
	ue.AmfUeNgapId = 1
	ue.AuthenticationSubs = GetEAPAKAPrimeAuthSubscription(UE_K, UE_OPC)
	...
	pdu := GetAuthenticationResponse(nil, base64.StdEncoding.EncodeToString(resEAPMessage))
