...
#
# usage:
# ./test-it-multiamfregistration.sh
#
# e.g. ./test-it-multiamfregistration.sh
#
##########################

echo "Running IT Multi-AMF Registration test"
...
cd goTest
go test -v -vet=off -run TestMultiAmfRegistration
go_test_exit_code=$?
cd ..
