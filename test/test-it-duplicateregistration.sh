...
#
# usage:
# ./test-it-duplicateregistration.sh
#
# e.g. ./test-it-duplicateregistration.sh
#
##########################

echo "Running IT Duplicate Registration test"
...
cd goTest
go test -v -vet=off -run TestDuplicateRegistration
go_test_exit_code=$?
cd ..
